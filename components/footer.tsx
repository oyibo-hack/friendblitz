...
function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      ...
      >
        <img src="/logo-big.png" alt="image" className={styles.footer__img1} />
        <img src="/logo-big.png" alt="image" className={styles.footer__img2} />
        ...
        <p className={styles.footer__copy}>
          © 2025 <span>Friend Blitz</span>. All rights reserved.
        </p>
      </div>
    </footer>
  );
